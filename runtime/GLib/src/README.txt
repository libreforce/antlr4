...
->seek = antlr_buffered_token_stream_interface_int_stream_seek

antlr_buffered_token_stream_sync
antlr_buffered_token_stream_fetch
TODO: antlr_lexer_interface_token_source_next_token
Mais avant il faut faire: Analyser dans atn.c
LL1Analyzer anal = new LL1Analyzer(this);
  -> BitSet

LexerATNSimulator
->antlr_lexer_atn_simulator_match
  ->antlr_lexer_atn_simulator_match_atn
    -> antlr_lexer_atn_simulator_get_epsilon_target
      -> antlr_lexer_atn_simulator_evaluate_predicate

antlr_lexer_atn_simulator_exec_atn


faire un point sur
php_lexer_get_decision_to_dfa

Finir deserializer( l'unicode pose des probleme...
antlr_atn_deserializer_deserialize


---------------------------------------------


antlr_parser_rule_context

current TODO
-> antlr_parser_consume
   -> errorHandler...
 ...
 ->Parser::enterRule()
    ->CommonTokenStream::LT(1)
       ->CommonTokenStream::lazyInit()
          ->CommonTokenStream::setup()
             ->BufferedTokenStream::sync(0)
                ->BufferedTokenStream::fetch()
                   ->Lexer::nextToken()
                      ->ANTLRInputStream::mark() return -1
                      ->ANTLRInputStream::index() return 0
                      ->
             ->Common|Buffered TokenStream::adjustSeekIndex(0)
...
public class BufferedTokenStream implements TokenStream {
    /**
     * The #AntlrTokenSource from which tokens for this stream are fetched.
     */
...
[X] public BufferedTokenStream(TokenSource tokenSource) {
        if (tokenSource == null) {
    ...
    @Override
[X] public TokenSource getTokenSource() { return tokenSource; }

    @Override
[X] public int index() { return p; }
...
[X] public int mark() {
    ...
    @Override
[X] public void release(int marker) {
...
//		if ( i>range ) range = i;
     ...
     * changed.
     *
     * <p>For example, #AntlrCommonTokenStream overrides this method to ensure that
