...
@lexer::members {/* start public lexer declarations section */
...
gboolean canTestFoo(/*TLexer *self*/) { return true; }
gboolean isItFoo() { return true; }
gboolean isItBar() { return true; }
