...
column_name
   : ( ( schema_name DOT )? ID DOT )? ID ( AS column_name_alias )? | ( table_alias DOT )? ID | USER_VAR ( column_name_alias )?
   ;
...
table_atom
   : ( table_name ( partition_clause )? ( AS table_alias )? ( index_hint_list )? )
