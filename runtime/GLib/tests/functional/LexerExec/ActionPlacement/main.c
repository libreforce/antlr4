...
static void
test_functional_lexer_exec_action_placement(void) {
...
static void
test_functional_lexer_exec_action_placement_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_action_placement();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_action_placement_test);
