...
static void
test_functional_lexer_exec_quote_translation(void) {
...
static void
test_functional_lexer_exec_quote_translation_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_quote_translation();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_quote_translation_test);
