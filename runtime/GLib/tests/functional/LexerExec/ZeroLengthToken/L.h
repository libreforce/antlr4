...
typedef enum _TestLRules    TestLRules;


enum _TestLSymbols {
  TEST_L_SYMBOL_ENDSTRING = 1, TEST_L_SYMBOL_BEGINSTRING = 2, TEST_L_SYMBOL_STRINGMODE_X = 3
};

enum _TestLRules {
  TEST_L_RULE_STRINGMODE = 1,
  TEST_L_RULE_ENDSTRINGMODE = 2,
};
