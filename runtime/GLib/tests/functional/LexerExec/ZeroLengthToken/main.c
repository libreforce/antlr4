...
static void
test_functional_lexer_exec_zero_length_token(void) {
...
static void
test_functional_lexer_exec_zero_length_token_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_zero_length_token();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_zero_length_token_test);
