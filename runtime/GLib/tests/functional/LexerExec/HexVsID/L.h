...
enum _TestLSymbols {
  TEST_L_SYMBOL_HEXLITERAL = 1, TEST_L_SYMBOL_DECIMALLITERAL = 2, TEST_L_SYMBOL_FLOATINGPOINTLITERAL = 3, 
  TEST_L_SYMBOL_DOT = 4, TEST_L_SYMBOL_ID = 5, TEST_L_SYMBOL_WS = 6
};
