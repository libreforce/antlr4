...
static void
test_functional_lexer_exec_ref_to_rule_does_not_set_token_nor_emit_another(void) {
...
static void
test_functional_lexer_exec_ref_to_rule_does_not_set_token_nor_emit_another_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_ref_to_rule_does_not_set_token_nor_emit_another();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_ref_to_rule_does_not_set_token_nor_emit_another_test);
