...
static void
test_functional_lexer_exec_greedy_positive_closure(void) {
...
static void
test_functional_lexer_exec_greedy_positive_closure_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_greedy_positive_closure();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_greedy_positive_closure_test);
