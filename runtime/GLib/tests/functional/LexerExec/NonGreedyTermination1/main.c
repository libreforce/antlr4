...
static void
test_functional_lexer_exec_non_greedy_termination1(void) {
...
static void
test_functional_lexer_exec_non_greedy_termination1_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_non_greedy_termination1();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_non_greedy_termination1_test);
