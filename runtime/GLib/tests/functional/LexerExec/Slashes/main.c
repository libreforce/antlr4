...
static void
test_functional_lexer_exec_slashes(void) {
...
static void
test_functional_lexer_exec_slashes_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_slashes();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_slashes_test);
