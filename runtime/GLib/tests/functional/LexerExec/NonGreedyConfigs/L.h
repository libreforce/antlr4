...
enum _TestLSymbols {
  TEST_L_SYMBOL_I = 1, TEST_L_SYMBOL_WS = 2, TEST_L_SYMBOL_J = 3
};
...
//virtual void test_l_action(TestL* self, AntlrRuleContext *context, size_t ruleIndex, size_t actionIndex);
