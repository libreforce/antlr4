...
static guint test_l_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 
};
...
static void test_l_action(AntlrRecognizer* self, AntlrRuleContext *context, gint ruleIndex, gint actionIndex) {
  switch (ruleIndex) {
    ...
    case 2: test_l_action_j(TEST_L(self), context, actionIndex); break;
...
void test_l_action_i(TestL* self, AntlrRuleContext *context, gint actionIndex) {
  ...
  switch (actionIndex) {
    case 0: g_print("%s\n", antlr_lexer_atn_simulator_get_text(ANTLR_LEXER_ATN_SIMULATOR(interpreter), ANTLR_LEXER(self)->input)); break;
...
void test_l_action_j(TestL* self, AntlrRuleContext *context, gint actionIndex) {
  AntlrATNInterpreter *interpreter = antlr_recognizer_get_interpreter(ANTLR_RECOGNIZER(self));
  switch (actionIndex) {
    case 1: g_print("%s\n", antlr_lexer_atn_simulator_get_text(ANTLR_LEXER_ATN_SIMULATOR(interpreter), ANTLR_LEXER(self)->input)); break;
