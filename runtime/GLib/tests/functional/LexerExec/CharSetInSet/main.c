...
static void
test_functional_lexer_exec_char_set_in_set(void) {
...
static void
test_functional_lexer_exec_char_set_in_set_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_char_set_in_set();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_char_set_in_set_test);
