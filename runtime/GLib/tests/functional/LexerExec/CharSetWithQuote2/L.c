...
static void test_l_action(AntlrRecognizer* self, AntlrRuleContext *context, gint ruleIndex, gint actionIndex) {
  switch (ruleIndex) {
    case 0: test_l_action_a(TEST_L(self), context, actionIndex); break;
...
void test_l_action_a(TestL* self, AntlrRuleContext *context, gint actionIndex) {
  switch (actionIndex) {
    case 0: g_print("A\n"); break;
