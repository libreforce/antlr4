...
static void
test_functional_lexer_exec_greedy_optional(void) {
...
static void
test_functional_lexer_exec_greedy_optional_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_greedy_optional();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_greedy_optional_test);
