...
static void
test_functional_lexer_exec_recursive_lexer_rule_ref_with_wildcard_plus_2(void) {
...
static void
test_functional_lexer_exec_recursive_lexer_rule_ref_with_wildcard_plus_2_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_recursive_lexer_rule_ref_with_wildcard_plus_2();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_recursive_lexer_rule_ref_with_wildcard_plus_2_test);
