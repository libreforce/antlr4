...
static void
test_functional_lexer_exec_non_greedy_closure(void) {
...
static void
test_functional_lexer_exec_non_greedy_closure_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_non_greedy_closure();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_non_greedy_closure_test);
