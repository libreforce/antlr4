...
static void
test_functional_lexer_exec_keyword_id(void) {
...
static void
test_functional_lexer_exec_keyword_id_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_keyword_id();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_keyword_id_test);
