...
static void
test_functional_lexer_exec_eof_suffix_in_first_rule_1(void) {
...
static void
test_functional_lexer_exec_eof_suffix_in_first_rule_1_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_eof_suffix_in_first_rule_1();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_eof_suffix_in_first_rule_1_test);
