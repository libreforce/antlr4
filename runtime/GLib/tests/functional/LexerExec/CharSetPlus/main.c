...
static void
test_functional_lexer_exec_char_set_plus(void) {
...
static void
test_functional_lexer_exec_char_set_plus_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_char_set_plus();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_char_set_plus_test);
