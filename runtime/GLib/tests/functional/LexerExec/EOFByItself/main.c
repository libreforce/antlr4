...
static void
test_functional_lexer_exec_eof_by_itself(void) {
...
static void
test_functional_lexer_exec_eof_by_itself_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_eof_by_itself();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_eof_by_itself_test);
