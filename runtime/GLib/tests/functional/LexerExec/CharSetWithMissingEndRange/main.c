...
static void
test_functional_lexer_exec_char_set_with_missing_end_range(void) {
...
static void
test_functional_lexer_exec_char_set_with_missing_end_range_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_lexer_exec_char_set_with_missing_end_range();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_lexer_exec_char_set_with_missing_end_range_test);
