...
static void test_l_action(TestL* self, AntlrRuleContext *context, gint ruleIndex, gint actionIndex) {
  switch (ruleIndex) {
    case 0: test_l_action_i(self, context, actionIndex); break;
