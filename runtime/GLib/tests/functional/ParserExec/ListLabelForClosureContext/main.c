...
static void
test_functional_t_parser_exec_list_label_for_closure_context(void) {
    ...
    TestContextExpression *context = test_t_parser_parse_expression(parser, &parser_error);
    if (context==NULL) {
        if (parser_error) {
...
static void
test_functional_t_parser_exec_list_label_for_closure_context_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_t_parser_exec_list_label_for_closure_context();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_t_parser_exec_list_label_for_closure_context_test);
