...
/**
 * test_t_listener_enter_b:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextB.
 */
void test_t_listener_enter_b  (TestTListener *self, TestContextB *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_b(self, ctx);
}
/**
 * test_t_listener_exit_b:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextB.
 */
void test_t_listener_exit_b   (TestTListener *self, TestContextB *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_b(self, ctx);
}
