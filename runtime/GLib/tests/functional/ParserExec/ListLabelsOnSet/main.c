...
static void
test_functional_t_parser_exec_list_labels_on_set(void) {
...
static void
test_functional_t_parser_exec_list_labels_on_set_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_t_parser_exec_list_labels_on_set();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_t_parser_exec_list_labels_on_set_test);
