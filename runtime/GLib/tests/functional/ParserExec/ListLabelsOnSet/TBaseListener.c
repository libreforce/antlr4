...
static void test_t_base_listener_interface_t_listener_enter_a(TestTListener *self, TestContextA *ctx) {
#if ENABLE_TRACE
...
static void test_t_base_listener_interface_t_listener_exit_a(TestTListener *self, TestContextA *ctx) {
#if ENABLE_TRACE
    gchar *str_text = antlr_parse_tree_get_text(ANTLR_PARSE_TREE(ctx));
    g_print("exit_a => %s\n", str_text);
    g_free(str_text);
...
static void test_t_base_listener_interface_t_listener_enter_b(TestTListener *self, TestContextB *ctx) {
#if ENABLE_TRACE
    gchar *str_text = antlr_parse_tree_get_text(ANTLR_PARSE_TREE(ctx));
    g_print("enter_b => %s\n", str_text);
    g_free(str_text);
...
static void test_t_base_listener_interface_t_listener_exit_b(TestTListener *self, TestContextB *ctx) {
#if ENABLE_TRACE
    gchar *str_text = antlr_parse_tree_get_text(ANTLR_PARSE_TREE(ctx));
    g_print("exit_b => %s\n", str_text);
    g_free(str_text);
...
{
    iface->enter_a = test_t_base_listener_interface_t_listener_enter_a;
    iface->exit_a = test_t_base_listener_interface_t_listener_exit_a;

    iface->enter_b = test_t_base_listener_interface_t_listener_enter_b;
    iface->exit_b = test_t_base_listener_interface_t_listener_exit_b;
