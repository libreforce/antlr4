...
enum _TestTParserTokens {
  TEST_T_PARSER_T__0 = 1, TEST_T_PARSER_ID = 2, TEST_T_PARSER_INT = 3, TEST_T_PARSER_FLOAT = 4, 
  TEST_T_PARSER_WS = 5
};
...
GList* test_context_b_token_get_float(TestContextB* self);// of AntlrTerminalNode*
