...
static void
test_functional_t_parser_exec_astar_2(void) {
...
static void
test_functional_t_parser_exec_astar_2_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_t_parser_exec_astar_2();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_t_parser_exec_astar_2_test);
