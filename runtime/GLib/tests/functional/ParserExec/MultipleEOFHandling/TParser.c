...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 0x03, 0x04, 0x0D, 0x04, 0x02, 0x09, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x05, 0x02, 0x08, 0x0A, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x02, 0x02, 0x03, 0x02, 0x02, 0x02, 0x0C, 0x02, 0x07, 0x03, 0x02, 0x02, 0x02, 0x04, 0x08, 0x07, 0x03, 0x02, 0x02, 0x05, 0x06, 0x07, 0x03, 0x02, 0x02, 0x06, 0x08, 0x07, 0x04, 0x02, 0x02, 0x07, 0x04, 0x03, 0x02, 0x02, 0x02, 0x07, 0x05, 0x03, 0x02, 0x02, 0x02, 0x08, 0x09, 0x03, 0x02, 0x02, 0x02, 0x09, 0x0A, 0x07, 0x02, 0x02, 0x03, 0x0A, 0x0B, 0x07, 0x02, 0x02, 0x03, 0x0B, 0x03, 0x03, 0x02, 0x02, 0x02, 0x03, 0x07
};
...
GList* test_context_prog_token_get_eof(TestContextProg* self) {
    return antlr_parser_rule_context_get_tokens(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_EOF);
}
AntlrTerminalNode *test_context_prog_at_token_get_eof(TestContextProg* self, size_t i) {
    return antlr_parser_rule_context_get_token(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_EOF, i);
}
