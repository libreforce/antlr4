...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 0x03, 0x04, 0x09, 0x04, 0x02, 0x09, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x02, 0x02, 0x03, 0x02, 0x02, 0x02, 0x07, 0x02, 0x04, 0x03, 0x02, 0x02, 0x02, 0x04, 0x05, 0x06, 0x02, 0x02, 0x02, 0x05, 0x06, 0x07, 0x03, 0x02, 0x02, 0x06, 0x07, 0x08, 0x02, 0x01, 0x02, 0x07, 0x03, 0x03, 0x02, 0x02, 0x02, 0x02
};
...
TestContextA* test_t_parser_parse_a(TestTParser* self, GError **error) {
    ...
    if (!(test_t_parser_property(self))){
        if (error!=NULL) {
            *error = g_error_new(g_quark_from_static_string("ANTLR"), 200, "FailedPredicate: %s", "Property()");
        }
        return NULL;
    }
...
gboolean test_t_parser_sempred(TestTParser *self, AntlrRuleContext *context, size_t ruleIndex, size_t predicateIndex) {
  switch (ruleIndex) {
...
gboolean test_t_parser_sempred_a(TestTParser* self, AntlrRuleContext *local_context, size_t predicateIndex) {
  switch (predicateIndex) {
    case 0: return test_t_parser_property(self);
