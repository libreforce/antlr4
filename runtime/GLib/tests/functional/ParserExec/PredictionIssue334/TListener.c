...
/**
 * test_t_listener_enter_file_:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextFile.
 */
void test_t_listener_enter_file_  (TestTListener *self, TestContextFile *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_file_(self, ctx);
}
/**
 * test_t_listener_exit_file_:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextFile.
 */
void test_t_listener_exit_file_   (TestTListener *self, TestContextFile *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_file_(self, ctx);
}

/**
 * test_t_listener_enter_item:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextItem.
 */
void test_t_listener_enter_item  (TestTListener *self, TestContextItem *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_item(self, ctx);
}
/**
 * test_t_listener_exit_item:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextItem.
 */
void test_t_listener_exit_item   (TestTListener *self, TestContextItem *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_item(self, ctx);
}
