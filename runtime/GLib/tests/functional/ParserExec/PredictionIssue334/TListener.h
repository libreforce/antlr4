 ...
 * @enter_file_: File enter event
 * @exit_file_: File exit event
 * @enter_item: Item enter event
 * @exit_item: Item exit event
 *
 *
...
struct _TestTListenerInterface
{
    ...
    /*< public >*/
    void (*enter_file_)  (TestTListener *self, TestContextFile *ctx);
    void (*exit_file_)   (TestTListener *self, TestContextFile *ctx);

    void (*enter_item)  (TestTListener *self, TestContextItem *ctx);
    void (*exit_item)   (TestTListener *self, TestContextItem *ctx);
