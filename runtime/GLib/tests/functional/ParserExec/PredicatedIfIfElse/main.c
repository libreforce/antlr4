...
static void
test_functional_t_parser_exec_predicated_if_if_else(void) {
    ...
    gchar *str = antlr_tree_to_string_tree(ANTLR_TREE(context), antlr_recognizer_get_rule_names(ANTLR_RECOGNIZER(parser)));
    g_print("%s\n", str);
...
static void
test_functional_t_parser_exec_predicated_if_if_else_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      test_functional_t_parser_exec_predicated_if_if_else();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", test_functional_t_parser_exec_predicated_if_if_else_test);
