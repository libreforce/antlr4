...
/**
 * test_t_listener_enter_stmt:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextStmt.
 */
void test_t_listener_enter_stmt  (TestTListener *self, TestContextStmt *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_stmt(self, ctx);
}
/**
 * test_t_listener_exit_stmt:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextStmt.
 */
void test_t_listener_exit_stmt   (TestTListener *self, TestContextStmt *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_stmt(self, ctx);
}

/**
 * test_t_listener_enter_if_stmt:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextIfStmt.
 */
void test_t_listener_enter_if_stmt  (TestTListener *self, TestContextIfStmt *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_if_stmt(self, ctx);
}
/**
 * test_t_listener_exit_if_stmt:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextIfStmt.
 */
void test_t_listener_exit_if_stmt   (TestTListener *self, TestContextIfStmt *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_if_stmt(self, ctx);
}
