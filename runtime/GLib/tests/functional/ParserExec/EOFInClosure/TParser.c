...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 
};
...
void test_context_prog_class_parser_rule_context_enter_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_enter_prog(TEST_T_LISTENER(listener), TEST_CONTEXT_PROG(self));
}

void test_context_prog_class_parser_rule_context_exit_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
...
TestContextProg *test_context_prog_new(AntlrParserRuleContext *parent, size_t invoking_state)
{
...
AntlrTerminalNode *test_context_prog_token_get_eof(TestContextProg* self) {
    return antlr_parser_rule_context_get_token(ANTLR_PARSER_RULE_CONTEXT(self), ANTLR_TOKEN_EOF, 0);
}
...
TestContextProg* test_t_parser_parse_prog(TestTParser* self, GError **error) {
    ...
    antlr_parser_match(ANTLR_PARSER(self), ANTLR_TOKEN_EOF);
...
GList* test_context_stat_token_get_eof(TestContextStat* self) {
    return antlr_parser_rule_context_get_tokens(ANTLR_PARSER_RULE_CONTEXT(self), ANTLR_TOKEN_EOF);
}
AntlrTerminalNode *test_context_stat_at_token_get_eof(TestContextStat* self, size_t i) {
    return antlr_parser_rule_context_get_token(ANTLR_PARSER_RULE_CONTEXT(self), ANTLR_TOKEN_EOF, i);
}
