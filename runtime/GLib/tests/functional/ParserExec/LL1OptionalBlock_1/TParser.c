...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 0x03, 0x05, 0x0C, 0x04, 0x02, 0x09, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x05, 0x02, 0x08, 0x0A, 0x02, 0x03, 0x02, 0x03, 0x02, 0x03, 0x02, 0x02, 0x02, 0x03, 0x02, 0x02, 0x02, 0x0C, 0x02, 0x07, 0x03, 0x02, 0x02, 0x02, 0x04, 0x08, 0x07, 0x03, 0x02, 0x02, 0x05, 0x06, 0x08, 0x02, 0x01, 0x02, 0x06, 0x08, 0x07, 0x04, 0x02, 0x02, 0x07, 0x04, 0x03, 0x02, 0x02, 0x02, 0x07, 0x05, 0x03, 0x02, 0x02, 0x02, 0x07, 0x08, 0x03, 0x02, 0x02, 0x02, 0x08, 0x09, 0x03, 0x02, 0x02, 0x02, 0x09, 0x0A, 0x08, 0x02, 0x01, 0x02, 0x0A, 0x03, 0x03, 0x02, 0x02, 0x02, 0x03, 0x07
};
...
AntlrTerminalNode *test_context_a_token_get_int(TestContextA* self) {
...
TestContextA* test_t_parser_parse_a(TestTParser* self, GError **error) {
    ...
    switch (antlr_int_stream_LA(ANTLR_INT_STREAM(ANTLR_PARSER(self)->input), 1)) {
      case TEST_T_PARSER_ID: {
        ...
        antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_ID);// TODO: untested LL1OptionalBlock
        break;
      }

      case TEST_T_PARSER_INT: {
        antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 4);
        antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_INT);// TODO: untested LL1OptionalBlock
        break;
      }

      case ANTLR_TOKEN_EOF: {
      // TODO: untested LL1OptionalBlock
        break;
      }
