...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 
};
...
GList* test_context_a_token_get_atn(TestContextA* self) {
    return antlr_parser_rule_context_get_tokens(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_ATN);
}
AntlrTerminalNode *test_context_a_at_token_get_atn(TestContextA* self, size_t i) {
    return antlr_parser_rule_context_get_token(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_ATN, i);
}
...
TestContextA* test_t_parser_parse_a(TestTParser* self, GError **error) {
    ...
    if (_la == TEST_T_PARSER_ATN) {
      antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 8);
      antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_ATN);
    }
