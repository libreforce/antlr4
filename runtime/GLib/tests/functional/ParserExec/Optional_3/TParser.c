...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 
};
...
void test_context_stat_class_parser_rule_context_enter_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_enter_stat(TEST_T_LISTENER(listener), TEST_CONTEXT_STAT(self));
}

void test_context_stat_class_parser_rule_context_exit_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_exit_stat(TEST_T_LISTENER(listener), TEST_CONTEXT_STAT(self));
}
...
TestContextStat *test_context_stat_new(AntlrParserRuleContext *parent, size_t invoking_state)
{
...
TestContextIfstat *test_context_stat_rule_get_ifstat(TestContextStat* self) {
    AntlrParserRuleContext *context = antlr_parser_rule_context_get_rule_context(ANTLR_PARSER_RULE_CONTEXT(self), TEST_TYPE_CONTEXT_IFSTAT, 0);
    return TEST_CONTEXT_IFSTAT(context);
}
...
TestContextStat* test_t_parser_parse_stat(TestTParser* self, GError **error) {
    ...
    switch (antlr_int_stream_LA(ANTLR_INT_STREAM(ANTLR_PARSER(self)->input), 1)) {
      case TEST_T_PARSER_T__1: {
        ...
        ret = (AntlrRuleContext*)test_t_parser_parse_ifstat(self, error);
    ...
    default:
      if (error!=NULL) {
          *error = g_error_new(g_quark_from_static_string("ANTLR"), 200, "NoViableAlt for rule '%s' in file '%s'", "stat", g_path_get_basename("T.g4") );
      }
      return NULL;
    }
...
/* virtual AntlrRuleContext */
gint test_context_ifstat_class_rule_context_get_rule_index(AntlrRuleContext *self) {
  return TEST_T_PARSER_IFSTAT;
}

/* virtual AntlrParserRuleContext */
void test_context_ifstat_class_parser_rule_context_enter_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_enter_ifstat(TEST_T_LISTENER(listener), TEST_CONTEXT_IFSTAT(self));
}

void test_context_ifstat_class_parser_rule_context_exit_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_exit_ifstat(TEST_T_LISTENER(listener), TEST_CONTEXT_IFSTAT(self));
}

/* virtual GObject */
static void test_context_ifstat_class_init(TestContextIfstatClass *klass);
static void test_context_ifstat_init(TestContextIfstat *gobject);

G_DEFINE_TYPE (TestContextIfstat, test_context_ifstat, ANTLR_TYPE_PARSER_RULE_CONTEXT)

static void
test_context_ifstat_class_init(TestContextIfstatClass *klass)
{
    AntlrParserRuleContextClass *parserrulecontext_class;
    AntlrRuleContextClass *rulecontext_class;
    ...
    parserrulecontext_class->enter_rule = test_context_ifstat_class_parser_rule_context_enter_rule;
    parserrulecontext_class->exit_rule = test_context_ifstat_class_parser_rule_context_exit_rule;

    rulecontext_class->get_rule_index = test_context_ifstat_class_rule_context_get_rule_index;
}

static void
test_context_ifstat_init (TestContextIfstat *object)
{
}

TestContextIfstat *test_context_ifstat_new(AntlrParserRuleContext *parent, size_t invoking_state)
{
    AntlrParserRuleContext *ctx = antlr_parser_rule_context_super_with_parent(TEST_TYPE_CONTEXT_IFSTAT, parent, invoking_state);
    TestContextIfstat *self = TEST_CONTEXT_IFSTAT(ctx);
    return self;
}

GList* test_context_ifstat_rule_get_stat(TestContextIfstat* self) {
    return antlr_parser_rule_context_get_rule_contexts(ANTLR_PARSER_RULE_CONTEXT(self), TEST_TYPE_CONTEXT_STAT);
}
TestContextStat* test_context_ifstat_at_rule_get_stat(TestContextIfstat* self, size_t i) {
    AntlrParserRuleContext *context = antlr_parser_rule_context_get_rule_context(ANTLR_PARSER_RULE_CONTEXT(self), TEST_TYPE_CONTEXT_STAT, i);
...
TestContextIfstat* test_t_parser_parse_ifstat(TestTParser* self, GError **error) {
    ...
    AntlrParserRuleContext *ctx = ANTLR_PARSER(self)->ctx;
    gint state = antlr_recognizer_get_state(ANTLR_RECOGNIZER(self));
    TestContextIfstat *local_context = test_context_ifstat_new(ctx, state);

    antlr_parser_enter_rule(ANTLR_PARSER(self), ANTLR_PARSER_RULE_CONTEXT(local_context), 0, TEST_T_PARSER_IFSTAT);
