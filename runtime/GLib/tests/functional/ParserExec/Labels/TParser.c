...
static guint test_t_parser_serialized_atn[] = {
  0x03, 0x0430, 0xD6D1, 0x8206, 0xAD2D, 0x4417, 0xAEF1, 0x8D80, 0xAADD, 
};
...
void test_context_a_class_parser_rule_context_enter_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_enter_a(TEST_T_LISTENER(listener), TEST_CONTEXT_A(self));
}

void test_context_a_class_parser_rule_context_exit_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
...
GList* test_context_a_rule_get_b(TestContextA* self) {
    return antlr_parser_rule_context_get_rule_contexts(ANTLR_PARSER_RULE_CONTEXT(self), TEST_TYPE_CONTEXT_B);
}
TestContextB* test_context_a_at_rule_get_b(TestContextA* self, size_t i) {
    AntlrParserRuleContext *context = antlr_parser_rule_context_get_rule_context(ANTLR_PARSER_RULE_CONTEXT(self), TEST_TYPE_CONTEXT_B, i);
    return TEST_CONTEXT_B(context);
}
...
TestContextA* test_t_parser_parse_a(TestTParser* self, GError **error) {
    ...
    ret = (AntlrRuleContext*)test_t_parser_parse_b(self, error);
    TEST_CONTEXT_A(local_context)->b1 =  (TestContextB*)ret;
    ...
    while (_la == TEST_T_PARSER_ID) {
      ...
      ret = (AntlrRuleContext*)test_t_parser_parse_b(self, error);
      TEST_CONTEXT_A(local_context)->bContext =  (TestContextB*)ret;
      if (ret==NULL || (error && *error)) {
          return NULL;
      }
      //TEST_CONTEXT_A(local_context)->b2.push_back(TEST_CONTEXT_A(local_context)->bContext);
      g_ptr_array_add(TEST_CONTEXT_A(local_context)->b2, (gpointer)TEST_CONTEXT_A(local_context)->bContext);
      antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 10);
      antlr_error_strategy_sync(ANTLR_PARSER(self)->err_handler, ANTLR_PARSER(self));
      _la = antlr_int_stream_LA(ANTLR_INT_STREAM(ANTLR_PARSER(self)->input), 1);
    }
    antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 11);
    TEST_CONTEXT_A(local_context)->s1 = 
    antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_T__0);
    //TEST_CONTEXT_A(local_context)->b3.push_back(TEST_CONTEXT_A(local_context)->s1);
    g_ptr_array_add(TEST_CONTEXT_A(local_context)->b3, (gpointer)TEST_CONTEXT_A(local_context)->s1);
...
/* virtual AntlrRuleContext */
gint test_context_b_class_rule_context_get_rule_index(AntlrRuleContext *self) {
  return TEST_T_PARSER_B;
}

/* virtual AntlrParserRuleContext */
void test_context_b_class_parser_rule_context_enter_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_enter_b(TEST_T_LISTENER(listener), TEST_CONTEXT_B(self));
}

void test_context_b_class_parser_rule_context_exit_rule(AntlrParserRuleContext *self, AntlrParseTreeListener *listener) {
    test_t_listener_exit_b(TEST_T_LISTENER(listener), TEST_CONTEXT_B(self));
}

/* virtual GObject */
static void test_context_b_class_init(TestContextBClass *klass);
static void test_context_b_init(TestContextB *gobject);

G_DEFINE_TYPE (TestContextB, test_context_b, ANTLR_TYPE_PARSER_RULE_CONTEXT)

static void
test_context_b_class_init(TestContextBClass *klass)
{
    AntlrParserRuleContextClass *parserrulecontext_class;
    AntlrRuleContextClass *rulecontext_class;
    ...
    parserrulecontext_class->enter_rule = test_context_b_class_parser_rule_context_enter_rule;
    parserrulecontext_class->exit_rule = test_context_b_class_parser_rule_context_exit_rule;

    rulecontext_class->get_rule_index = test_context_b_class_rule_context_get_rule_index;
}

static void
test_context_b_init (TestContextB *object)
{
}

TestContextB *test_context_b_new(AntlrParserRuleContext *parent, size_t invoking_state)
{
    AntlrParserRuleContext *ctx = antlr_parser_rule_context_super_with_parent(TEST_TYPE_CONTEXT_B, parent, invoking_state);
    TestContextB *self = TEST_CONTEXT_B(ctx);
    return self;
}
...
GList* test_context_b_token_get_int(TestContextB* self) {
    return antlr_parser_rule_context_get_tokens(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_INT);
}
AntlrTerminalNode *test_context_b_at_token_get_int(TestContextB* self, size_t i) {
    return antlr_parser_rule_context_get_token(ANTLR_PARSER_RULE_CONTEXT(self), TEST_T_PARSER_INT, i);
}
...
TestContextB* test_t_parser_parse_b(TestTParser* self, GError **error) {
    ...
    AntlrParserRuleContext *ctx = ANTLR_PARSER(self)->ctx;
    gint state = antlr_recognizer_get_state(ANTLR_RECOGNIZER(self));
    TestContextB *local_context = test_context_b_new(ctx, state);

    antlr_parser_enter_rule(ANTLR_PARSER(self), ANTLR_PARSER_RULE_CONTEXT(local_context), 0, TEST_T_PARSER_B);
    size_t _la = 0;

    antlr_parser_enter_outer_alt(ANTLR_PARSER(self), ANTLR_PARSER_RULE_CONTEXT(local_context),  1);
    antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 13);
    TEST_CONTEXT_B(local_context)->id_ = 
    antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_ID);
    antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 17);
    antlr_error_strategy_sync(ANTLR_PARSER(self)->err_handler, ANTLR_PARSER(self));
    _la = antlr_int_stream_LA(ANTLR_INT_STREAM(ANTLR_PARSER(self)->input), 1);
    while (_la == TEST_T_PARSER_INT) {
      antlr_recognizer_set_state(ANTLR_RECOGNIZER(self), 14);
      TEST_CONTEXT_B(local_context)->intToken = 
      antlr_parser_match(ANTLR_PARSER(self), TEST_T_PARSER_INT);
      //TEST_CONTEXT_B(local_context)->val.push_back(TEST_CONTEXT_B(local_context)->intToken);
      g_ptr_array_add(TEST_CONTEXT_B(local_context)->val, (gpointer)TEST_CONTEXT_B(local_context)->intToken);
