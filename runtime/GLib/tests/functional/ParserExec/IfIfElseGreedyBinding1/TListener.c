...
/**
 * test_t_listener_enter_statement:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextStatement.
 */
void test_t_listener_enter_statement  (TestTListener *self, TestContextStatement *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_statement(self, ctx);
}
/**
 * test_t_listener_exit_statement:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextStatement.
 */
void test_t_listener_exit_statement   (TestTListener *self, TestContextStatement *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_statement(self, ctx);
}
