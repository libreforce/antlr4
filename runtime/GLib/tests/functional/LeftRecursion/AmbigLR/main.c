...
static void
functional_left_recursion_ambig_lr(void) {
...
static void
functional_left_recursion_ambig_lr_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      functional_left_recursion_ambig_lr();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", functional_left_recursion_ambig_lr_test);
