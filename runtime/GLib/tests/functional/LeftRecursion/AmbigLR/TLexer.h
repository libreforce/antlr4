...
enum _TestTLexerSymbols {
  ...
  TEST_T_LEXER_SYMBOL_MUL = 4, TEST_T_LEXER_SYMBOL_DIV = 5, TEST_T_LEXER_SYMBOL_ADD = 6, 
  TEST_T_LEXER_SYMBOL_SUB = 7, TEST_T_LEXER_SYMBOL_ID = 8, TEST_T_LEXER_SYMBOL_INT = 9, 
  TEST_T_LEXER_SYMBOL_NEWLINE = 10, TEST_T_LEXER_SYMBOL_WS = 11
};
