...
static void
functional_left_recursion_java_expressions(void) {
...
static void
functional_left_recursion_java_expressions_test (void)
{
  ...
  if (g_test_subprocess ())
    {
      functional_left_recursion_java_expressions();
      return;
    }
...
int main(int argc, char* argv[]) {
    ...
    g_test_add_func("/test", functional_left_recursion_java_expressions_test);
