...
/**
 * test_t_listener_enter_declarator:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Enter a parse tree produced by #TestContextDeclarator.
 */
void test_t_listener_enter_declarator  (TestTListener *self, TestContextDeclarator *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->enter_declarator(self, ctx);
}
/**
 * test_t_listener_exit_declarator:
 * @self: Some #TestTListener
 * @ctx: the parse tree instance
 *
 * Exit a parse tree produced by #TestContextDeclarator.
 */
void test_t_listener_exit_declarator   (TestTListener *self, TestContextDeclarator *ctx) {
    g_assert(TEST_IS_T_LISTENER(self));
    TEST_T_LISTENER_GET_INTERFACE(self)->exit_declarator(self, ctx);
}
