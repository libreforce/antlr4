...
TestContextA *test_context_a_new(AntlrParserRuleContext *parent, gint invokingState);
...
TestContextA* test_t_parser_parse_a_with_precedence(TestTParser* self, gint precedence, GError **error);
